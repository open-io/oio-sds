...
_generate_api_alias(const M2V2Bean_t * asn)
{
	...
	metautils_asn_INTEGER_to_int64(&(asn->alias->version), &i64);
	...
	metautils_asn_INTEGER_to_int64(&(asn->alias->ctime), &i64);
	ALIASES_set_ctime(result, i64);

	metautils_asn_INTEGER_to_int64(&(asn->alias->mtime), &i64);
...
_generate_api_header(const M2V2Bean_t * asn)
{
	...
	metautils_asn_INTEGER_to_int64(&(asn->header->size), &i64);
	CONTENTS_HEADERS_set_size(result, i64);

	metautils_asn_INTEGER_to_int64(&(asn->header->ctime), &i64);
	CONTENTS_HEADERS_set_ctime(result, i64);

	metautils_asn_INTEGER_to_int64(&(asn->header->mtime), &i64);
...
_generate_api_chunk(const M2V2Bean_t * asn)
{
	...
	metautils_asn_INTEGER_to_int64(&(asn->chunk->size), &i64);
	CHUNKS_set_size(result, i64);

	metautils_asn_INTEGER_to_int64(&(asn->chunk->ctime), &i64);
...
_generate_api_prop(const M2V2Bean_t * asn)
{
	...
	metautils_asn_INTEGER_to_int64(&(asn->prop->version), &av);
...
_header_to_asn(gpointer api, M2V2Bean_t *asn)
{
	...
	metautils_asn_int64_to_INTEGER(&(asn->header->size), CONTENTS_HEADERS_get_size(header));
	metautils_asn_int64_to_INTEGER(&(asn->header->ctime), CONTENTS_HEADERS_get_ctime(header));
	metautils_asn_int64_to_INTEGER(&(asn->header->mtime), CONTENTS_HEADERS_get_mtime(header));
...
_chunk_to_asn(gpointer api, M2V2Bean_t *asn)
{
	...
	metautils_asn_int64_to_INTEGER(&(asn->chunk->size), CHUNKS_get_size(chunk));
	metautils_asn_int64_to_INTEGER(&(asn->chunk->ctime), CHUNKS_get_ctime(chunk));
...
_property_to_asn(gpointer api, M2V2Bean_t *asn)
{
	...
	metautils_asn_int64_to_INTEGER(&(asn->prop->version), PROPERTIES_get_version(prop));
...
_alias_to_asn(gpointer api, M2V2Bean_t *asn)
{
	...
	metautils_asn_int64_to_INTEGER(&(asn->alias->version), ALIASES_get_version(alias));
	...
	metautils_asn_int64_to_INTEGER(&(asn->alias->ctime), ALIASES_get_ctime(alias));

	metautils_asn_int64_to_INTEGER(&(asn->alias->mtime), ALIASES_get_mtime(alias));
