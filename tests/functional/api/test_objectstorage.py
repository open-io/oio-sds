...
class TestObjectStorageApi(ObjectStorageApiTestBase):
    ...
    def test_container_refresh(self):
        ...
        ref_time = time.time()
        # FIXME(FVE): find why event processing is slow,
        # and find a better way to wait for event processing.
        time.sleep(2.0)  # ensure container event have been processed
