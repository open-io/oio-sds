...
class FullpathTest(unittest.TestCase):
    def test_encode(self):
        ...
        self.assertEqual(
            "myaccount/mycontainer/myobject/9876543210/0123456789ABCDEF", fullpath
        )
    ...
    def test_encode_with_utf8_info(self):
        fullpath = encode_fullpath(
            "mŷaccount", "mycontainér", "myöbject", 9876543210, "0123456789ABCDEF"
        )
        self.assertEqual(
            "m%C5%B7account/mycontain%C3%A9r/my%C3%B6bject/9876543210/0123456789ABCDEF",
            fullpath,
        )
    ...
    def test_decode_with_wrong_format(self):
        self.assertRaises(
            ValueError, decode_fullpath, "myaccount/mycontainer/myobject/9876543210"
        )
