...
enum http_rc_e
action_dir_prop_get (struct req_args_s *args, json_object *jargs);

enum http_rc_e
action_dir_prop_set (struct req_args_s *args, json_object *jargs);

enum http_rc_e
action_dir_prop_del (struct req_args_s *args, json_object *jargs);

enum http_rc_e
action_dir_srv_list (struct req_args_s *args);

enum http_rc_e
action_dir_srv_link (struct req_args_s *args, json_object *jargs);

enum http_rc_e
action_dir_srv_unlink (struct req_args_s *args);

enum http_rc_e
action_dir_srv_force (struct req_args_s *args, json_object *jargs);

enum http_rc_e
action_dir_srv_renew (struct req_args_s *args, json_object *jargs);
...
enum http_rc_e
action_m2_container_purge (struct req_args_s *args, json_object *jargs);

enum http_rc_e
action_m2_container_dedup (struct req_args_s *args, json_object *jargs);

enum http_rc_e
action_m2_container_touch (struct req_args_s *args, json_object *jargs);

enum http_rc_e
action_m2_container_raw_insert (struct req_args_s *args, json_object *jargs);

enum http_rc_e
action_m2_container_raw_update (struct req_args_s *args, json_object *jargs);

enum http_rc_e
action_m2_container_raw_delete (struct req_args_s *args, json_object *jargs);

enum http_rc_e
action_m2_container_propget (struct req_args_s *args, json_object *jargs);

enum http_rc_e
action_m2_container_propset (struct req_args_s *args, json_object *jargs);

enum http_rc_e
action_m2_container_propdel (struct req_args_s *args, json_object *jargs);

enum http_rc_e
action_m2_container_stgpol (struct req_args_s *args, json_object *jargs);

enum http_rc_e
action_m2_container_setvers (struct req_args_s *args, json_object *jargs);
...
enum http_rc_e
action_m2_content_beans (struct req_args_s *args, json_object *jargs);

enum http_rc_e
action_m2_content_touch (struct req_args_s *args, json_object *jargs);

enum http_rc_e
action_m2_content_propget (struct req_args_s *args, json_object *jargs);

enum http_rc_e
action_m2_content_propset (struct req_args_s *args, json_object *jargs);

enum http_rc_e
action_m2_content_propdel (struct req_args_s *args, json_object *jargs);

enum http_rc_e
action_m2_content_stgpol (struct req_args_s *args, json_object *jargs);

enum http_rc_e
action_m2_content_spare (struct req_args_s *args, json_object *jargs);
...
enum http_rc_e
action_sqlx_propget (struct req_args_s *args, json_object *jargs);

enum http_rc_e
action_sqlx_propset (struct req_args_s *args, json_object *jargs);

enum http_rc_e
action_sqlx_propdel (struct req_args_s *args, json_object *jargs);

enum http_rc_e
action_sqlx_leave (struct req_args_s *args, json_object *jargs);

enum http_rc_e
action_sqlx_ping (struct req_args_s *args, json_object *jargs);

enum http_rc_e
action_sqlx_status (struct req_args_s *args, json_object *jargs);

enum http_rc_e
action_sqlx_info (struct req_args_s *args, json_object *jargs);

enum http_rc_e
action_sqlx_leanify (struct req_args_s *args, json_object *jargs);

enum http_rc_e
action_sqlx_resync (struct req_args_s *args, json_object *jargs);

enum http_rc_e
action_sqlx_debug (struct req_args_s *args, json_object *jargs);

enum http_rc_e
action_sqlx_copyto (struct req_args_s *args, json_object *jargs);

enum http_rc_e
action_sqlx_freeze (struct req_args_s *args, json_object *jargs);

enum http_rc_e
action_sqlx_enable (struct req_args_s *args, json_object *jargs);

enum http_rc_e
action_sqlx_disable (struct req_args_s *args, json_object *jargs);

enum http_rc_e
action_sqlx_disable_disabled (struct req_args_s *args, json_object *jargs);
