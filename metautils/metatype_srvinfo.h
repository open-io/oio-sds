...
void service_info_merge_tags (struct service_info_s *dst, struct service_info_s *src);
...
/* Appends to 'out' a json representation of 'si'. If full is FALSE, the
 * namespace and the service type will be omitted */
