...
gint64 namespace_get_keep_deleted_delay(const struct namespace_info_s *ni);
gchar* namespace_get_strvalue(const struct namespace_info_s *ni, const char *k, const char *d);
gint64 namespace_get_int64(const struct namespace_info_s *ni, const char* k, gint64 d);

gboolean namespace_in_worm_mode (const struct namespace_info_s* ni);
gboolean namespace_in_compression_mode (const struct namespace_info_s* ni);
gint64 namespace_container_max_size (const struct namespace_info_s* ni);
gint64 namespace_chunk_size (const struct namespace_info_s* ni, const char *ns_name);
gchar* namespace_storage_policy (const struct namespace_info_s* ni, const char *ns_name);
gboolean namespace_is_storage_policy_valid (const struct namespace_info_s* ni, const char *pol);
gchar* namespace_data_security_value (const struct namespace_info_s *ni, const char *pol);
gchar* namespace_storage_policy_value (const struct namespace_info_s *ni, const char *pol);
gchar* namespace_get_service_update_policy(const struct namespace_info_s *nsinfo);
gint64 namespace_get_container_max_versions(const struct namespace_info_s *nsinfo);

gsize namespace_get_autocontainer_src_offset (const struct namespace_info_s* ni);
gsize namespace_get_autocontainer_src_size (const struct namespace_info_s* ni);
gsize namespace_get_autocontainer_dst_bits (const struct namespace_info_s* ni);
