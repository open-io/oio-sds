...
/* Opens a non-blocking TCP/IP socket and connects to a remote host identified
 * by the given addr_info_t structure. Internally, the function will be mapped
 * to a sockaddr structure used with regular sockets. */
