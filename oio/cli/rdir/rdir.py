...
class RdirAssignments(Lister):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            help=(
                "(Enable 'check') Minimum required distance between any service "
        ...
        parser.add_argument(
            ...
            default=DEFAULT_RDIR_REPLICAS,
            action=ValueCheckStoreTrueAction,
            help="(Enable 'check') Number of rdirs per service.",
        )
        return parser
    ...
    def take_action(self, parsed_args):
        ...
        if parsed_args.aggregated and parsed_args.check:
            raise ValueError("--aggregated and --check are mutualy exclusive")
