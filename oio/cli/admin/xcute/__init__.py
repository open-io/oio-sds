...
class XcuteCommonRdirRawxCommand(XcuteCommand, ShowOne):
    """
    Class holding rdir/rawx-related parameters.
    """

    JOB_CLASS = None

    def get_parser(self, prog_name):
        parser = super(XcuteCommonRdirRawxCommand, self).get_parser(prog_name)
...
class XcuteRdirCommand(XcuteCommonRdirRawxCommand):
    """
