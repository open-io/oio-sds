...
from oio.cli.admin.xcute import XcuteCommonRdirRawxCommand, XcuteRdirCommand
...
class RawxDecommission(SingleServiceCommandMixin, XcuteCommonRdirRawxCommand):
    """
