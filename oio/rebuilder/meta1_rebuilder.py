...
class Meta1Rebuilder(MetaRebuilder):
    ...
    def _fill_queue(self, queue, **kwargs):
        ...
        hosted_services = self.conscience.all_services(
            "rawx"
    ...
    def _get_report(self, status, end_time, counters, **kwargs):
        prefixes_processed, errors, total_prefixes_processed, total_errors = counters
        ...
        return (
            ...
            % {
                ...
                "prefixes_rate": prefixes_processed / time_since_last_report,
                "errors": errors,
                "errors_rate": 100 * errors / float(prefixes_processed or 1),
                "start_time": datetime.fromtimestamp(int(self.start_time)).isoformat(),
                "total_time": total_time,
                "total_prefixes": total_prefixes_processed,
                "total_prefixes_rate": total_prefixes_processed / total_time,
...
class Meta1RebuilderWorker(MetaRebuilderWorker):
    def __init__(self, rebuilder, **kwargs):
        super(Meta1RebuilderWorker, self).__init__(rebuilder, "meta1", **kwargs)
