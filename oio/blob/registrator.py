...
class BlobRegistrator(object):
    ...
    def __init__(self, conf, logger, volume, container_ids):
        ...
        self.client = ContainerClient({"namespace": self.namespace}, logger=self.logger)
    ...
    def _get_report(self, status, end_time):
        ...
        report = (
            ...
            % {
                ...
                "chunks_processed_rate": self.chunks_processed / total_time,
                "chunk_errors": self.chunk_errors,
                "chunk_errors_rate": 100
                * self.chunk_errors
        ...
        for bean_type in self.BEAN_TYPES:
            report = (
                ...
                % {
                    ...
                    "beans_processed_rate": self.beans_processed[bean_type]
                    / total_time,
                    "bean_successes": self.bean_successes[bean_type],
                    "bean_successes_rate": 100
    ...
    def pass_volume(self):
        ...
        return self.chunk_errors == 0 and all(
            errors == 0 for errors in self.bean_errors.values()
        )
    ...
    def pass_chunk_file(self, path):
        ...
        with open(path) as f:
            ...
            if self.container_ids and meta["container_id"] in self.container_ids:
                self.logger.debug(
            ...
            for bean in beans:
                try:
                    ...
                    self.bean_errors[bean["type"]] = self.bean_errors[bean["type"]] + 1

    def pass_bean(self, meta, bean):
        try:
            self.beans_processed[bean["type"]] = self.beans_processed[bean["type"]] + 1
            ...
            self.bean_successes[bean["type"]] = self.bean_successes[bean["type"]] + 1
            ...
            self.bean_orphans[bean["type"]] = self.bean_orphans[bean["type"]] + 1
        except Exception as exc:
            self.logger.error(
