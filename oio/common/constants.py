...
SHARDING_STATE_NAME = {
    ...
    str(CONTAINER_TO_SHARD_STATE_SAVING_WRITES): 'Saving writes',
    str(CONTAINER_TO_SHARD_STATE_LOCKED): 'Locked',
    str(CONTAINER_TO_SHARD_STATE_SHARDED): 'Sharded',
    str(CONTAINER_TO_SHARD_STATE_ABORTED): 'Aborted',
    str(NEW_SHARD_STATE_APPLYING_SAVED_WRITES): 'Applying saved writes',
    str(NEW_SHARD_STATE_CLEANED_UP): 'Cleaned up',
}
