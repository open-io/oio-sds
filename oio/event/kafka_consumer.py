...
class KafkaConsumerWorker(Process, KafkaRejectorMixin, AcknowledgeMixin):
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        AcknowledgeMixin.__init__(self, offsets_queue=offsets_queue, logger=logger)
        self.endpoint = endpoint
...
class KafkaBatchFeeder(
    Process, KafkaRejectorMixin, KafkaOffsetHelperMixin, AcknowledgeMixin
):
    def __init__(
        self,
        endpoint,
