...
func (rc *Behavior) SetIndex(tgt *client.RawxTarget, index uint) { rc.RawxClient.Refresh(tgt, index) }

func (rc *Behavior) GetIndex() uint { return rc.RawxClient.GetIndex() }
