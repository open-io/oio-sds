...
#ifndef LOG_DOMAIN
# define LOG_DOMAIN "gridcluster.agent.event.configure"
#endif
#ifdef HAVE_CONFIG_H
# include "../config.h"
#endif
...
#include "../events/eventhandler_internals.h"
...
agent_start_indirect_event_config(const gchar *ns_name, GError **error)
{
	...
	task = set_task_callbacks(create_task(get_event_refresh_delay(NULL), task_id),
