...
#ifndef OIO_SDS__cluster__agent__cpu_stat_task_worker_h
# define OIO_SDS__cluster__agent__cpu_stat_task_worker_h 1
...
#endif /*OIO_SDS__cluster__agent__cpu_stat_task_worker_h*/